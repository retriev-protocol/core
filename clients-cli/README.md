...
```
CONTRACT_ADDRESS=0x6A530F53428736Bd198811Dc28DCb6033936357d
WEB3_PROVIDER=https://rpc.ankr.com/base_sepolia
API_URL=https://api-sepolia.retr.dev
```

You're ready to interact with retrieval protocol!
...
Please make sure to make a backup of this key and never share it. You will be able to import it in Metamask or other wallets. You will probably need some spare testnet `ETH` and you can ask them from [Base's testnet faucet](https://docs.base.org/docs/tools/network-faucets/).
...
├─────────┼─────────────────────────────┼──────────────────────────────────────────────┼───────────┼──────────┼───────────────────────────┼──────────────┤
│    0    │ 'https://provider.retr.dev' │ '0x4C0Fb89b2506B2E286D8F0cc05913CD3eBb68682' │     1     │ 20000000 │           1000            │      90      │
└─────────┴─────────────────────────────┴──────────────────────────────────────────────┴───────────┴──────────┴───────────────────────────┴──────────────┘
Done in 1.02s.
```
...
```
yarn deal --dealuri='ipfs://bafkreidlrmxrhd45dljz34f54txu7affj27xv2fmbqv7oumpnlptljpcuu' --provider='0x2489c48090523f37028f1e42454b7DD04943d0Bf' --duration=60 --value=0 --collateral=0
```
...
│    1    │    58     │ 'ipfs://bafkreidlrmxrhd45dljz34f54txu7affj27xv2fmbqv7oumpnlptljpcuu' │     '0'      │ '0x2489c48090523f37028f1e42454b7DD04943d0Bf' │ 2022-08-30T04:59:43.000Z │ 2022-10-29T04:59:43.000Z │
└─────────┴───────────┴──────────────────────────────────────────────────────────────────────┴──────────────┴──────────────────────────────────────────────┴──────────────────────────┴──────────────────────────┘
Done in 1.03s.
```
...
```
yarn retrieve --dealuri=ipfs://bafkreidlrmxrhd45dljz34f54txu7affj27xv2fmbqv7oumpnlptljpcuu
```
...
Please remember that any appeal will cost you some `ETH` so be 100% sure file is not retrievable or you will basically lose money.
...
Feel free to open issues or PR to contribute the project or join our [?](?) to chat with us!